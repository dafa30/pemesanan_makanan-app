package com.dafa_adi_raharjo_uts.catering.main;
...
import com.dafa_adi_raharjo_uts.catering.R;
import com.dafa_adi_raharjo_uts.catering.history.HistoryOrderActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setCategories() {
        modelCategories = new ModelCategories(R.drawable.ic_complete, "Paket Lengkap");
        ...
        modelCategoriesList.add(modelCategories);
        modelCategories = new ModelCategories(R.drawable.ic_fast, "Cemilan");
        modelCategoriesList.add(modelCategories);
        modelCategories = new ModelCategories(R.drawable.ic_event, "Paket Acara");
        modelCategoriesList.add(modelCategories);
    ...
    private void setTrending() {
        modelTrending = new ModelTrending(R.drawable.complete_1,"Menu 1", "5.100 disukai");
        modelTrendingList.add(modelTrending);
        modelTrending = new ModelTrending(R.drawable.complete_2,"Menu 2", "2.300 disukai");
        modelTrendingList.add(modelTrending);
        modelTrending = new ModelTrending(R.drawable.complete_3,"Menu 3", "1.100 disukai");
        modelTrendingList.add(modelTrending);
        modelTrending = new ModelTrending(R.drawable.complete_4,"Menu 4", "590 disukai");
        modelTrendingList.add(modelTrending);
        modelTrending = new ModelTrending(R.drawable.complete_6,"Menu 5", "450 disukai");
        modelTrendingList.add(modelTrending);
